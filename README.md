...
Therefore, following is a code snippet of the implementation of a persistant connection mechanism to allow for connection to NCache Pub/Sub servers, the details of which can be found [here](https://github.com/Obaid-Rehman/NCacheServiceFabric/blob/master/src/BuildingBlocks/EventBusNCache/DefaultNCachePersistentConnection.cs):
